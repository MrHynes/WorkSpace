            ...
            <ul class="nav" id="main-menu">
                ...
                <li><a href="#" id="SystemSetting"><i class="fa fa-dashboard "></i>系统设置<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="systemSet.jsp"><i class="fa fa-toggle-on"></i>图书馆信息</a></li>
                        <li><a href="adminSet.jsp"><i class="fa fa-bell "></i>管理员设置</a></li>
                        <li><a href="paramSet.jsp"><i class="fa fa-bank "></i>参数设置</a></li>
                        <li><a href="bookShelfSet.jsp"><i class="fa fa-barcode "></i>书架设置</a></li>
                    </ul>
                 </li>
