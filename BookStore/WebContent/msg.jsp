...
<body>
	...
	<div class="container">
			...
			<div class="col-lg-6">
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<label style="font-size: 50px; color: #4cae4c"><span
							class="glyphicon glyphicon-ok-circle"></span></label>
						<%
                    ...
                    %>
						<p><%=msg %></p>
						<p>
							您的帐号是:<%=request.getAttribute("name") %></p>
					</div>
		...
		<a href="index.jsp" class="btn btn-success">点击这里</a> <a
			href="shoppingCart.jsp" class="btn btn-success">购物车</a>
		<%
