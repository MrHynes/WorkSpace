    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover">
                        ...
                        %>
                            ...
                            <td width="500px">
                            	<img src="img/pro.png" width="<%=votes.getNum()*5%>" height="20px">
                            	<%=votes.getNum() %>
                            </td>
                            <td width="150px"><a href="doVoters?id=<%=votes.getId()%>&num=<%=votes.getNum() %>">投票</a></td>
                       	 	</tr>
                        <%
                        }
                        %>
                ...
                <div class="panel panel-footer text-center">Copyright ©2017 程祺004</div>
            </div>
        </div>
