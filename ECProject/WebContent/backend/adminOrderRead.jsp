...
<div class="modal fade" id="modifyOrder" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" style="width: 700px;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="admOrder?task=modifyOrder&orderid=<%=orderInfoBean.getOrderID()%>" method="post">
						<table class="table table-bordered">
							...
							<tr>
								<td>
									<select class="form-control" name="sendway">
										<option selected="selected"><%=orderInfoBean.getSendWay()%></option>
										<option>送货上门</option>
										<option>自提点自提</option>
									</select>
								</td>
								<td><input class="form-control" type="text" name="receiver" value="<%=orderInfoBean.getReceiver() %>"></td>
								<td><input class="form-control" type="text" name="address" value="<%=orderInfoBean.getAddress()%>"></td>
							</tr>
							<thead>
								<th>邮编</th>
								<th>联系电话</th>
							...
							<tr>
								<td><input class="form-control" type="text" name="postcode" value="<%=orderInfoBean.getPostCode()%>"></td>
								<td><input class="form-control" type="text" name="telephone" value="<%=orderInfoBean.getTelePhone() %>"></td>
								<td><input class="form-control" type="text" name="email" value="<%=orderInfoBean.getEmail()%>"></td>
							</tr>
						</table>
						<input type="submit" value="确定" class="btn btn-success" style="width: 130px;"> 
						<input type="reset" value="重置" class="btn btn-warning" style="width: 130px;">
