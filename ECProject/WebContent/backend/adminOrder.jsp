				...
				<div class="col-lg-12">
					...
					<table class="table table-horver">
						...
						<tr>
							...
							<td class="col-lg-3">
								<a href="createOrder?task=showDetailOrder&orderid=<%=infoBean.getOrderID()%>&flag=admin">
									<input class="btn btn-success" value="查看" style="width:55px;height: 30px;">
								</a>
								<a href="createOrder?task=showDetailOrder&orderid=<%=infoBean.getOrderID()%>&flag=admin">
									<input class="btn btn-primary" value="审核" style="width:55px;height: 30px;">
								</a>
								<a href="createOrder?task=showDetailOrder&orderid=<%=infoBean.getOrderID()%>&flag=admin">
									<input class="btn btn-warning" value="修改" style="width:55px;height: 30px;">
								</a>
							</td>
						</tr>
						<%} %>
