		...
		<ul class="nav" id="main-menu">
			<li>
				<div class="user-img-div">
					<img src="<%=basePath %>simg/9787894204622.jpg" class="img-thumbnail" /></br>
			...
			<li><a class="active-menu" href="" id="goodAdmin"><i
				...
				<ul class="nav nav-second-level">
					<li><a href="<%=basePath %>backend/getTypes?task=getTypes"><i
							class="fa fa-toggle-on"></i>商品类别管理</a></li>
					<li><a href="<%=basePath %>backend/admGood?task=getGoods"><i class="fa fa-bell "></i>商品信息管理</a>
					</li>
				</ul></li>
			<li><a href="#" id="userAdmin"><i class="fa fa-desktop "></i>用户管理
					<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="<%=basePath %>backend/admUser?task=getUser"><i
							class="fa fa-circle-o "></i>注册用户管理</a></li>
					<li><a href="<%=basePath %>backend/admInfo?task=getAdmin&flag=systemuser" ><i class="fa fa-code "></i>系统用户管理</a>
					</li>
				</ul></li>
			<li><a href="#" id="perInfoAdmin"><i class="fa fa-yelp "></i>个人资料管理
					<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="<%=basePath %>backend/admInfo?task=getAdmin&flag=showmyinfo" id="showInfo"><i
			...
			<li><a id="orderAdmin"><i class="fa fa-flash "></i>订单管理
					<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="<%=basePath %>backend/admOrder?task=getOrders"><i
