	...
	<div class="col-lg-5">
		<form action="searchByKey" method="post">
			...
			<div class="input-group">
				<input type="text" class="form-control" placeholder="输入关键字|商品名称或者描述" style="height: 45px; width: 450px;" name="key" /> 
				<span class="input-group-btn">
					<input type="submit" value="查询" class="btn btn-primary" style="height: 43px; width: 70px;">
				</span>
			</div>
			</div>
			<div class="col-lg-3"></div>
