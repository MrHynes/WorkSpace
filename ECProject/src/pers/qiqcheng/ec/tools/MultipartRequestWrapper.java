package pers.qiqcheng.ec.tools;
...
public class MultipartRequestWrapper extends HttpServletRequestWrapper {
    ...
    //F:\\WorkSpace\\ECProject\\WebContent\\temp\\
    //private static String PATH = "E:\\temp\\"; //设置上传路径
    private static String PATH = "F:\\WorkSpace\\ECProject\\WebContent\\simg\\"; //设置上传路径
                ...
                while (iter.hasNext()){
                    ...
                    if (item.isFormField()){//如果是非文件域,设置进入map,这里要注意多值处理
                        ...
                        if (is.available()>0){//如果输出流的内容大于0
                            ...
                            Streams.copy(is,new FileOutputStream(PATH+goodID+".jpg"),true);//拷贝内容到上传路径
