        ...
        <div class="col-lg-12">
            <div class="col-lg-12">
                ...
                <div class="panel panel-success">
                	<!-- 支付的时候库存要减一 -->
                    <div class="panel-heading"><span class="glyphicon glyphicon-jpy"></span> &nbsp;确认订单信息<br></div>
                   <form action="error.jsp" method="post">
                    ...
                    <div class="panel-footer">
                    	...
                    	<form action="inventory?isbn=<%=paybook.getIsbn()%>" method="post">
                    	 ...
                    	 -->
                    	<div class="btn btn-success"><a href="inventory?isbn=<%=paybook.getIsbn()%>" style="color: white;">支付</a></div>
                    </div>
                    </form>
                </div>
            </div>
