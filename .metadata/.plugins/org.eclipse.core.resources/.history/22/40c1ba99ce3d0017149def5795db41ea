...
<%
	...
	if (pageBean != null && goodList != null&&goodsID!=null) {
            ...
            <div class="col-lg-5"> 
                <div class="panel">
                    ...
                    <div class="panel-body" style="height: 350px;">
                        ...
                        <p><h3>[商品名称]:<%=goodsBean.getGoodName() %></h3></p>
                        <br>
                        <p><h3>[商品价格]:${price}</h3></p>
                        <br>
                        <p><h3>[商品库存]:<%=goodsBean.getInventory() %></h3></p>
                    </div>
                </div>
                <button class="btn btn-success" value="购买"></button>
                <button class="btn btn-warning" value="加入购物车"></button>
                <br>
            </div>
            <div class="col-lg-3">
            	<div class="panel">
            		...
            		<div class="panel-body" style="height: 350px;" >
						...
						<img  src="../img/<%=goodsBeanNext.getGoodImage() %>.jpg" width="220px;" height="220px;">
						<br>
